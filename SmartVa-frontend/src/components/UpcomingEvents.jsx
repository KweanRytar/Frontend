...
{venue}</small>
<button    onClick={() => navigate(`/event-details/${event._id}`, {state: {event}})}
                 className='rounded-3xl border-gray-500 bg-[#00b86b] p-2 text-white cursor-pointer text-center'>View</button>
</div>
