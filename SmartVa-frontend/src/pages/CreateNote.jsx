...
const CreateNote = () => {
  ...
  return (
    <form className="min-h-screen bg-gray-50 dark:bg-gray-900 dark:text-white" onSubmit={handleSubmit}>
      {/* FIXED HEADER */}
      <div className="fixed top-14 md:top-24  left-0 right-0  z-30 bg-white dark:bg-[#1E293B] border-b border-gray-200 dark:border-gray-700 p-4 md:p-6 flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
